...
public class Creeper extends ProtBase
{
	...
	public void load() throws Exception
	{
		...
		{
			fTimeSinceIgnited = EntityCreeper.class.getDeclaredField("timeSinceIgnited");
			fFuseTime = EntityCreeper.class.getDeclaredField("fuseTime");
			fExplosionRadius = EntityCreeper.class.getDeclaredField("explosionRadius");
		}
		/*
		 ...
		 *
		 *	FD: qc/e net/minecraft/src/EntityCreeper/field_70833_d
		 *	FD: qc/f net/minecraft/src/EntityCreeper/field_82225_f
		 *	FD: qc/g net/minecraft/src/EntityCreeper/field_82226_g
		 */
		else
		{
	...
	@Override
	public boolean loaded() { return fExplosionRadius != null; }
	@Override
	public boolean isEntityInstance(Entity e) { return e instanceof EntityCreeper; }
	
	@Override
	public String update(Entity e) throws Exception
	{
		EntityCreeper creeper = (EntityCreeper)e;
		if (creeper.getCreeperState() < 1) // not exploding
			return null;
        ...
        if (e.isEntityAlive())
        {
            timeSinceIgnited += creeper.getCreeperState(); // +1 exploding, -1 calming down
